...
int Sequence[8][100] = {
						...
						{201,2,7,8,7,7,8,7,5,206,9,7,8,8,7,216,6,8,6},
						{201,2,8,7,8,5,204,9,7,201,8,215,7,6},
						{5,217},
						{0},
						{0},
						{0}}; 
...
void Drive_UtlStop(){//5
	resettime();
	while(true){
		if(!GetPrevSpeed(0)&&!GetPrevSpeed(3)&&seconds()>1){
			drive(0,0);
			return;
		}else if(dhs(1)){
			wait(0.05);
...
void Act_05(){//205  电脑
	drive(30,30);
	while(GetPrevSpeed(0)||GetPrevSpeed(3)){;}
	setServ(85,1023);
	drive(-30,-30);
	wait(0.5);
	drive(0,0);
...
void Act_19(){//219  慢速utlstop 
	...
	while(true){
		if(!GetPrevSpeed(0)&&!GetPrevSpeed(3)&&seconds()>1){
			...
			wait(0.05);
			drive(lSpeed_5-10,hSpeed_5-10);
		}else if(dhs(5)){
		   wait(0.05);
			drive(hSpeed_5-10,lSpeed_5-10);
		}else if(dhs(2)){
			drive(mSpeed_5-10,hSpeed_5-10);
		}else if(dhs(4)){
			drive(hSpeed_5-10,mSpeed_5-10);
		}else{
			drive(hSpeed_5-10,hSpeed_5-10);
		}
	}
}
void Act_20(){//220
