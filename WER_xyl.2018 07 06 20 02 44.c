...
//=================SEQUENCE=================//
//子程序序列(0-49) 
int Sequence[50][100]= {{2,201,7,8,7,6,6,7,5,109,9,201,8,8,7,8,8,7,5,105,201,212,10,8,8,8,7,8,7,10,5,104,201,212,9,6,6,8,5,111,201,9,8,9,8,113,202,9,8,6,114},
						{8,9}, 
						{},
						{},
						{}, //交换
